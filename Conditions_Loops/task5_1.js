...
let averageGrade = 85;
if (averageGrade <60 ){ 
    console.log(`Your grade is too low  ${averageGrade } - Незадовільно `)

} else if (averageGrade >=60 && averageGrade<=70 ) {
    console.log(`Your grade is average  ${averageGrade } - Задовільно `)
} else if (averageGrade <=80 && averageGrade >70 ) {
    console.log(`Your grade is fine ${averageGrade } - Добре `)
} else if (averageGrade <=90 && averageGrade >80 ) {
    console.log(`Your grade is fine ${averageGrade } - Дуже добре `)
} else if (averageGrade <=100 && averageGrade >90 ) {
    console.log(`Well done - ${averageGrade} -Відмінно`)
}
else {
    console.log("Your grade is not valid, sorry")
}